...
(async () => {
  ...
  model = await tf.loadLayersModel("budget-model/model.json");
...
ctx.fillText("Generating Mango...", 5, 15);
...
function animateK() {
  computing_animate_latent_space(model, 2, 200);
